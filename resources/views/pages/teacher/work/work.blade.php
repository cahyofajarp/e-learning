...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <a href="{{ route('teacher.work.student.create',[$classroom,$lesson]) }}" class="btn btn-custom-green mb-3">
                    <i class="mdi mdi-plus"></i> Tambah Tugas / Materi
                </a>
                <div class="table-responsive">
                    
                    <table class="table  table-hover table-striped" id="myTable" style="width:180%">
                            ...
                            @foreach ($works->sortByDesc('created_at') as $work)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @else 
                                            <span class="btn btn-success px-3" style="border-radius: 100px;font-size:14px"><i class="mdi mdi-check"></i> {{ $work->type == 'MATERI' ? 'Materi' : 'Tugas' }} Sukses Dibuat</span>
                                        @endif
                                    </td>
                                    <td>
                                        
                                        <a href="{{ route('teacher.work.student.preview',[$classroom,$lesson,$work]) }}" class="btn btn-info btn-sm  mb-2"><i class="mdi mdi-eye"></i> Preview {{ $work->type == 'MATERI' ? 'Materi' : 'Tugas' }}</a> <br>
                                        <a href="{{ route('teacher.work.student.edit',[$classroom,$lesson,$work]) }}" class="btn btn-custom-yellow btn-sm mb-2"><i class="mdi mdi-pencil "></i> Edit</a> <br>
                                        <button data-delete="{{ route('teacher.work.student.destroy',[$classroom,$lesson,$work]) }}" id="btn-delete" class="btn btn-danger btn-sm d-block mb-2"><i class="mdi mdi-delete "></i> Delete</button>
                                        <a href="{{ route('teacher.work.student.score',[$classroom,$lesson,$work]) }}" class="btn btn-success btn-sm"> <i class="mdi mdi-pencil-box"></i> Lihat / Nilai</a>
                                    </td>
                                </tr>
                            <?php $no++; ?>
                            @endforeach
