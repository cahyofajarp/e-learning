...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <form id="formData" action="{{ route('teacher.work.student.update',[$classroom,$lesson,$work]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('put')
                ...
                <div class="form-group">
                    ...
                    <select name="type" class="form-control" style="border:2px dotted #707170">
