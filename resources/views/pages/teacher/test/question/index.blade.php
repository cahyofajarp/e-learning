...
<div class="modal fade" id="importExcel" tabindex="-1" role="dialog" aria-labelledby="importExcel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content" style="background-color: white !important">
        ...
        <form method="post" action="{{ route('teacher.lesson.test.question.importExcelQuestion',[$classroom,$lesson,$test]) }}" enctype="multipart/form-data" id="formDataImport">
            @csrf
        ...
        <div class="card">
            <div class="card-body">
                <div class="btn-group mb-4">
                    <a href="{{ route('teacher.lesson.test.question.Questioncreate',[$classroom,$lesson,$test]) }}" class="btn btn-custom-green"> <i class="mdi mdi-plus"></i> Tambah Pertanyaan</a>
                ...
                <form action="{{ route('teacher.lesson.test.question.destroySelect',[$classroom,$lesson,$test]) }}" method="post" id="selectDel">
                @csrf
                        ...
                        <tbody>
                            ...
                            @foreach ($questions as $question)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('teacher.lesson.test.question.edit',[$classroom,$lesson,$test,$question,$no]) }}" class="btn btn-custom-yellow btn-sm "><i class="mdi mdi-pencil"></i> Edit</a>
                                        <button class="btn btn-custom-red btn-sm" id="btn-delete" data-delete="{{ route('teacher.lesson.test.question.destroy',[$classroom,$lesson,$test,$question]) }}">
