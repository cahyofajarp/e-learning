                        ...
                        <thead class="btn-custom-green-blue">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="btn btn-success">{{ $testCountLesson->tests()->where('lesson_id',$lesson->id)->count() }} Test</span>
                                    </td>

                                    <td>
                                        <button data-lesson="{{ $lesson->code }}" data-redirect="{{ route('teacher.lesson.test.index',[$classroom,$lesson]) }}" data-check="{{ route('teacher.lesson.checkCode',[$classroom,$lesson]) }}" 
                                                class="btn btn-info" 
                                                id="btn-test"> <i class="mdi mdi-clipboard"></i> Tambah Test</button>
