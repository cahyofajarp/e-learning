...
<div class="row">
    <div class="col-md-12">
        <div class="alert alert-warning">
            <H5>Noted : </H5>
            <p>Kelas ini adalah kelas yang anda ajar.</p>
        </div>
        <div class="card">
            <div class="card-body">
                                ...
                                @foreach ($lessonteacher->classroom()->get() as $classroom)
                                  <tr>
                                      ...
                                      <td>
                                        ...
                                        <td><span class="badge badge-info"><b>{{ $classroom->students()->count() }}</b> Siswa</span></td>
                                      <td><a href="{{ route('teacher.test.statistik.lesson',$classroom) }}" class="btn btn-custom-green px-3 py-2 btn-sm" style="border-radius: 100px"> <i class="mdi mdi-eye"></i> Lihat Detail</a></td>
                                  </tr>
                                <?php $no++; ?>
                                @endforeach
                            @endforeach
