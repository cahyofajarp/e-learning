...
<form action="{{ route('admin.test.question.store',[$classroom,$lesson,$test]) }}" method="POST" id="formData">
    @csrf
                    ...
                    <div class="card">
                        <div class="card-body">
                                <div class="form-group">
                                    <div class="float-right">No. 1</div>
...
function scoreSystem(val){
    if(val == 1){
        ...
        $.get('{{ route("admin.test.test.question.questionCheck",[$classroom,$lesson,$test]) }}',function(data) {
            let hightValue = 100;
                    ...
                    '<div class="col-md-10  ">' +
                        '<div class="card card'+i+'"> '+
                            '<div class="card-body-append card-body"> '+
                                '<div class="float-right number">No. '+i+'</div>'+
                                '<div class="form-group"> ' +
                                   ' <label for="">*Pertanyaan</label> ' +
                                   ' <small class="d-block mb-2">Noted : Tulis pertanyaan.</small> ' +
...
$('#formData').submit(function(e) {
    ...
    $.ajax({
        ...
        contentType: false,
        processData: false,
        url: "{{ route('admin.test.question.store',[$classroom,$lesson,$test]) }}",
        beforeSend:function(){
