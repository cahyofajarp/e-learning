        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-striped d-table" id="myTable" style="width: 100%">
                        <thead class="btn-custom-green-blue">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {{-- <span class="btn btn-success">{{ $lesson->tests()->where('lesson_id',$lesson->id)->count() }} Test</span> --}}
                                    </td>
                                    <td>
                                        {{-- <button data-lesson="{{ $lesson->code }}" data-redirect="{{ route('admin.test.testCreate',[$classroom,$lesson]) }}" data-check="{{ route('admin.test.checkCode',[$classroom,$lesson]) }}" 
                                                class="btn btn-info" id="btn-test"> <i class="mdi mdi-clipboard"></i> Tambah Test</button> --}}
                                        <button id="btn-test" data-lesson="{{ $lesson->code }}" class="btn btn-custom-green" data-redirect="{{ route('admin.studentWork.index',[$classroom,$lesson]) }}" data-check="{{ route('admin.studentWork.checkCode',[$classroom,$lesson]) }}"> <i class="mdi mdi-plus"></i> Tambah Tugas</button>
                                    </td>
